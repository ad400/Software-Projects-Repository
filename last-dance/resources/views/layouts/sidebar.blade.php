<nav class="shadow-sm shadow-gray-400 bg-[#1c1c1c] w-56  flex flex-col p-6 lg:w-56 lg:block hidden">
    <div class="flex items-center justify-center mb-6">
        <img src="{{ asset('storage/images/fluency_logo_white.png') }}" alt="Fluency Logo"
            class="w-[160px] h-auto object-contain" style="mix-blend-mode: screen;">
    </div>
...
<div class="lg:hidden bg-[#1c1c1c] shadow-sm shadow-gray-400 fixed top-0 left-0 w-full z-50">
    <div class="flex items-center justify-between p-4">
        <div>
            <img src="{{ asset('storage/images/fluency_logo_white.png') }}" alt="Fluency Logo" class="w-[120px]" style="mix-blend-mode: screen;">
        </div>
